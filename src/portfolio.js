...
const settings = {
  isSplash: false, 
  useCustomCursor: true, // false for good'ol cursor
...
const degrees = {
  degrees: [
    {
      title: "Vellore Institute Of Technology University",
...
const certifications = {
  certifications: [
    {
      title: "Dummy",
      subtitle: "Dummy MongoDB University",
      logo_path: "mongo.png",
      certificate_link:
        "/",
      alt_name: "MongoDB Dummy",
      color_code: "#47A048",
    },
    {
    ...
    {
      title: "Dummy Atlas",
      subtitle: "Dummy MongoDB",
      logo_path: "mongo.png",
      certificate_link:
        "/",
      alt_name: "Dummy MongoDB",
      color_code: "#47A048",
    },
    {
      title: "Dummy Cyber Security",
      subtitle: "Dummy Workshop",
      logo_path: "iit.png",
      certificate_link:
        "/",
      alt_name: "Dummy Workshop",
      color_code: "#2AAFED",
    },
    {
      title: "Dummy dummy",
      subtitle: "Dummy Hacking",
...
const experience = {
  ...
  description:
    "I am currently doing 2 internship programs. I've mostly done projects on my own and I am actively looking for internships.",
      ...
      experiences: [
        {
          ...
          duration: "Xmonth 20xx - Ymonth 20xx",
          location: "Dummy,India",
          description: `Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, numquam. Quia, doloribus, adipisci et fugiat repellat rem iure cum deserunt quibusdam impedit numquam minima, eius magnam explicabo nostrum velit pariatur.
          Vitae id ipsam adipisci similique possimus? Recusandae voluptatum expedita magni odit impedit obcaecati quo illum, cupiditate sit necessitatibus, voluptate non autem nam asperiores, minus dolor dolore itaque voluptates incidunt suscipit.
          Adipisci ea iste earum eveniet nemo veritatis ab asperiores eligendi excepturi expedita, culpa odio inventore id quas quasi harum placeat voluptatem molestias blanditiis ipsa quam sed. Nisi repellendus eveniet quos.`,
          color: "#0071C5",
        },
        {
          title: "Dummy2",
          ...
          description: `Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo impedit sit iusto harum maxime nisi cum corrupti nam corporis a, perferendis id non, asperiores veniam earum laboriosam? Minus, ipsum earum.
          Nihil, itaque sed numquam temporibus maxime, ducimus est beatae vero accusantium, ut deleniti recusandae iusto ex eum ab voluptas? Eum obcaecati expedita nostrum, quod velit voluptatem! Labore neque laboriosam ut.`,
          color: "#ee3c26",
        },
      ],
    },
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of latest technology tools. My best experience is to create NodeJS Backend Projects, JavaScript Projects, and React Project. Below are some of Dummy projects. Note --- it is Dummy for the task, *not mine* ",
